...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "productservice@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "productservice API";

        private String description = "productservice API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "productservice";
